...
def Refinement_generation(prediction, dataset_name, img_path,  client, output_path):
    original_text = "Original Text: {" + prediction[1]["text"] + "}\n"
...
def Save_result(final_result, img_id, scale, output_path):
...
def call_LLM(img_path, input_path, output_path, dataset_name, max_threads=1, model_name="gemma-3-4b-it", name="base"):
